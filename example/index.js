...
(function(exports) {
  ...
  var findOne = function (v) {
      return function (f) {
          return Control_Monad_Aff.makeAff(function (onError) {
              return function (onSuccess) {
                  return Control_Monad_Eff_Uncurried.runEffFn4($foreign.findOneImpl)(Control_Monad_Eff_Uncurried.mkEffFn1(onError))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($97) {
                      return onSuccess(Data_Nullable.toMaybe($97));
                  }))(v.value1)(f);
              };
          });
      };
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.sync(v))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Database_Sequelize.findOne(v1)({
                      ...
                      if (v2 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.get(v2.value0)({
                              plain: true
                          })))(function (v3) {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v3.foo);
                          });
                      };
                      throw new Error("Failed pattern match at Main line 51, column 5 - line 57, column 28: " + [ v2.constructor.name ]);
                  });
              });
          });
      })))();
