...
(function(exports) {
  ...
  var main = function __do() {
      ...
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.errorShow(Control_Monad_Eff_Exception.showError))(Control_Monad_Eff_Console.log)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.authenticate(v))(function () {
          ...
          })(Database_Sequelize_Fields.sqlNOW)(Database_Sequelize_Fields.emptyModelDefinition))))))(function (v1) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Data_Functor["void"](Control_Monad_Aff.functorAff)(Database_Sequelize.create(v1)({
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Database_Sequelize.create(v2)({}))(function (v4) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Database_Sequelize.findOne(v1)({
                                      ...
                                      throw new Error("Failed pattern match at Main line 58, column 5 - line 65, column 43: " + [ v5.constructor.name ]);
                                  });
                              });
                          });
                      });
