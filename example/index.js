...
(function(exports) {
  ...
  exports["sqlDATE"] = $foreign.sqlDATE;
  exports["sqlINTEGER"] = $foreign.sqlINTEGER;
  exports["sqlJSON"] = $foreign.sqlJSON;
  exports["sqlNOW"] = $foreign.sqlNOW;
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.errorShow(Control_Monad_Eff_Exception.showError))(Control_Monad_Eff_Console.log)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.authenticate(v))(function () {
          ...
          })("foo!")(Database_Sequelize_Fields.addFieldWithDefault(Data_Record_Class.srInst())(new Data_Symbol.IsSymbol(function () {
              return "time";
          }))()(Data_Symbol.SProxy.value)({
              type: Database_Sequelize_Fields.sqlDATE
          })(Database_Sequelize_Fields.sqlNOW)(Database_Sequelize_Fields.addField(Data_Record_Class.srInst())(new Data_Symbol.IsSymbol(function () {
              return "ayy";
          }))()()(Data_Symbol.SProxy.value)({
              type: Database_Sequelize_Fields.sqlJSON
          })(Database_Sequelize_Fields.emptyModelDefinition)))))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.define(v)("baz")(Database_Sequelize_Fields.addFieldWithDefault(Data_Record_Class.srInst())(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Database_Sequelize.hasMany(v1)(v2))(function (v3) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.sync(v))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Data_Functor["void"](Control_Monad_Aff.functorAff)(Database_Sequelize.create(v1)({
                              bar: 1, 
                              ayy: Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonInt))([ 1 ])
                          })))(function () {
                                      ...
                                      if (v5 instanceof Data_Maybe.Just) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v3.set(v5.value0)([ v4 ]))(function () {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.get(v5.value0)({
                                                  ...
                                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Unsafe_Coerce.unsafeCoerce(v6));
                                              });
                                          });
                                      };
                                      throw new Error("Failed pattern match at Main line 62, column 5 - line 69, column 29: " + [ v5.constructor.name ]);
                                  });
                              });
                          });
                      });
