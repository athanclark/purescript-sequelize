...
(function(exports) {
  ...
  var showDialect = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Database.Sequelize line 39, column 1 - line 39, column 37: " + [ v.constructor.name ]);
  });
  ...
  var save = function (i) {
      return Control_Monad_Aff.makeAff(function (onError) {
          return function (onSuccess) {
              return Control_Monad_Eff_Uncurried.runEffFn3($foreign.saveImpl)(Control_Monad_Eff_Uncurried.mkEffFn1(onError))(Control_Monad_Eff_Uncurried.mkEffFn1(onSuccess))(i);
          };
      });
  };
  var makeField = function (dictSubrow) {
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.errorShow(Control_Monad_Eff_Exception.showError))(Control_Monad_Eff_Console.logShow(Data_Show.showString))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.authenticate(v))(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.define(v)("foo")({
              foo: Database_Sequelize.makeField(Data_Record_Class.srInst())({
                  type: Database_Sequelize.sqlSTRING, 
                  defaultValue: "foo!"
              }), 
              bar: Database_Sequelize.makeField(Data_Record_Class.srInst())({
                  type: Database_Sequelize.sqlINTEGER
              })
          })))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Database_Sequelize.sync(v))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.build(v1)({
                      bar: 1
                  })))(function (v2) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Database_Sequelize.save(v2))(function (v3) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Database_Sequelize.get(v3)({
                              plain: true
                          })))(function (v4) {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v4.foo);
                          });
                      });
                  });
              });
