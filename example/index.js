...
(function(exports) {
  ...
  var sequelize = function (dictSubrow) {
      return function (x) {
          return Control_Monad_Eff_Uncurried.runEffFn1($foreign.sequelizeImpl(dictSubrow))(toSequelizeImplParams(x));
      };
  };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      Control_Monad_Eff_Console.log(Unsafe_Coerce.unsafeCoerce(args))();
      var v = Database_Sequelize.sequelize(Data_Record_Class.srInst())(args)();
